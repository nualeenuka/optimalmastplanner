...
from .OptimalMeasurementPlanner_dialog import OptimalMeasurementPlannerDialog
import os.path
import warnings
...
class OptimalMeasurementPlanner:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'OptimalMeasurementPlanner_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&OptimalMeasurementPlanner')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('OptimalMeasurementPlanner', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/OptimalMeasurementPlanner/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u''),
            callback=self.run,
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&OptimalMeasurementPlanner'),
                action)
    ...
    def init_ui(self):
        ...
        icon = QIcon(":/plugins/OptimalMeasurementPlanner/folder.png")
    ...
    def run(self):
        ...
        self.dlg = OptimalMeasurementPlannerDialog()
